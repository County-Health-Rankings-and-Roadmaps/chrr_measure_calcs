---
title: "v147 Life Expectancy (subgroups) - Rankings 2026"
...
## pop: age_cat 1-18 for 2021, 2022, 2023 by subgroups

```{r}
pop_agecat_1_18 <- bind_rows(  
  process_pop_v147(2021), 
  process_pop_v147(2022)%>% fix_CT_pop(process_pop_v147(2021)),
  process_pop_v147(2023) %>% fix_CT_pop(process_pop_v147(2021)),
  ) %>%  
...
```{r}
v147_other <- process_race_data_wide(v147_2, fips, "v147") %>% 
...
```{r}
v147_other_2 <- v147_other %>%
  add_flag_CT(vnum="v147_race", old = "U", new = "A")
...
```{r}
compare_subgroup("v147", v147_other_2, 2026)
```
...
# save data
```{r}
save_data(v147_other_2, "v147_otherdata")
```
