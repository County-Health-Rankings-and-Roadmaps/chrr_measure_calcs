...
## Census pop data 2020-2024 by age cat 1-10
...
pop_agecat_1_10 <- bind_rows(
  ...
  process_pop_v161(2023) %>% 
    fix_CT_pop(process_pop_v161(2021)),
  process_pop_v161(2024) %>% 
    fix_CT_pop(process_pop_v161(2021))
  ) %>% 
...
mort_all <- bind_rows(
  ...
  process_mort_v161(2023, icd_v161 = icd_code_lst), 
  process_mort_v161(2024, icd_v161 = icd_code_lst), 
  ) %>% 
  group_by(statecode, countycode, age_cat) %>% 
